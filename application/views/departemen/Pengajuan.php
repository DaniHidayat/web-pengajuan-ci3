            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        <a href="<?= base_url('departement/tambahpengajuan') ?>" class="btn btn-success"><i
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url($item['file_bukti']) ?>"
                                                    ...
                                                    Berkas Pengajuan</a>
                                                <a href="<?= base_url('departement/editpengajuan/'.$item['id_pengajuan']) ?>"
                                                    class="btn btn-warning btn-sm"><i class="bi bi-pencil"></i> Edit</a>
                                                <a href="<?= base_url('departement/hapuspengajuan/'.$item['id_pengajuan']) ?>"
