<main id="main" class="main">
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= base_url('provinsi/anggarandaerah') ?>">Home</a></li>
                        ...
                        <div class="card recent-sales overflow-auto">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-end mb-3">
                                    <!-- <a href="<?= base_url('Kabkota/tambahitem?id_pengajuan='.$id_pengajuan) ?>"
                                        type="button" class="btn btn-success mx-3" data-toggle="modal"
                                        data-target="#addModal"><i class="bi bi-plus"></i>Tambah
                                        item</a> -->
                                    <a href="<?= base_url('departement/anggarankabkota') ?>" type="button"
