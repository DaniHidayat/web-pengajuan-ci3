                                ...
                                <table class="table table-borderless datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('departement/lihatpengajuan/'.$item['id_pengajuan']) ?>"
                                                    class="btn btn-info btn-sm"><i class="bi bi-eye"></i> View</a>
                                                <a href="<?= base_url('departement/editanggaran/'.$item['id_pengajuan']) ?>"
                                                    class="btn btn-warning btn-sm">Edit</a>
                                                <a href="<?= base_url('departement/hapuspengajuan2/'.$item['id_pengajuan']) ?>"
