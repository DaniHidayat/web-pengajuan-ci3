            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <a href="<?php echo site_url('Accountdept/addprov'); ?>" type="button"
                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $users['name_prov']; ?></td>
                                    <td><?php echo $users['email']; ?></td>
                                    <td><?php echo $users['username']; ?></td>
                                    <td><?php echo $users['role']; ?></td>
                                    <td>

                                        <a href="<?php echo site_url('departement/editprov/'.$users['id']); ?>"
                                            class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Edit</a>
                                        <a href="<?php echo site_url('departement/deleteprov/'.$users['id']); ?>"
