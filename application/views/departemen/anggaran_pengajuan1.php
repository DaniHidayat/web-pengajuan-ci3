<main id="main" class="main">
    ...
    ?>">
                                            ...
                                            <td>
                                                <a href="<?= base_url('Departement/lihatpengajuan1/'.$item['id_pengajuan']) ?>"
                                                    class="btn btn-info btn-sm"><i class="bi bi-eye"></i> Lihat
                                                    Pengajuan</a>
                                                <!-- <a href="<?= base_url('Departement/editanggaran1/'.$item['id_pengajuan']) ?>"
                                                    class="btn btn-warning btn-sm"><i class="bi bi-pencil"></i> Edit</a> -->
                                                <a href="<?= base_url('Departement/hapuspengajuan1/'.$item['id_pengajuan']) ?>"
