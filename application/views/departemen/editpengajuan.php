<main id="main" class="main">
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= base_url('departement') ?>">Home</a></li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-end mb-3">
                                    <a href="<?= base_url('departement/tambahitem?id_pengajuan='.$id_pengajuan) ?>"
                                        ...
                                        item</a>
                                    <a href="<?= base_url('departement/anggaranpribadi') ?>" type="button"
                                        class="btn btn-secondary ml-2"><i class="bi bi-arrow-left"></i>
                                        Kembali</a>
                                </div>

                                <?php if (!empty($import_dept)) : ?>
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                    ...
                                    <tbody>
                                        <?php foreach ($import_dept as $index => $row): ?>
                                        <tr>
                                            <td><?= $index + 1 ?></td>
                                            <td><?= $row->Program ?></td>
                                            <td><?= $row->Kegiatan ?></td>
                                ...
                                <div class="text-right mt-3">
                                    ...
                                    <a href="<?= base_url('departement/downloadDatadept/' . $id_pengajuan) ?>"
