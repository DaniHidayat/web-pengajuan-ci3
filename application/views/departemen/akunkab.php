            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php endif; ?> -->
                        <h5 class="card-title">Akun kabupaten/kota</h5>
                        <!-- Table with stripped rows -->
                        <div class="mb-3">
                            <a href="<?php echo site_url('accountdept/addkab'); ?>" type="button"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo site_url('departement/editkab/'.$users['id']); ?>"
                                            class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Edit</a>
                                        <a href="<?php echo site_url('departement/deletekab/'.$users['id']); ?>"
