    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?= base_url('Provinsi/anggarandaerah') ?>">
                <i class="bi bi-layout-text-window-reverse"></i><span>lihat anggaran daerah</span>
            </a>

        </li>
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?= base_url('Provinsi/akunkabkota') ?>">
                <i class="bi bi-layout-text-window-reverse"></i><span>Kelola akun kab/kota</span>
            </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?= base_url('Provinsi/Profile') ?>">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?= base_url('Provinsi/faq') ?>">
