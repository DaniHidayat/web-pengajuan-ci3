                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- Form -->
                                <form action="<?php echo site_url('provinsi/updatekab'); ?>" method="post">
                                    <br>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" class="form-control" id="password" name="password"
                                            placeholder="Isi password baru jika ingin mengubah" required>
                                    </div>
                                    <!-- <div class="mb-3">
                                        ...
                                        <select class="form-select" id="wilayah" name="wilayah" required>
                                            ...
                                            <option value="<?= $row['id'] ?>"
                                                <?= $row['ID_Provinsi'] == $users['ID_kotakab'] ? 'selected' : '' ?>>
                                                <?= $row['name_prov'] ?>
                                            </option>
                                            <?php endforeach; ?>
                                        </select>
