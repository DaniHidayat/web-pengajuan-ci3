                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- Form -->
                                <form action="<?= base_url('Kabkota/tambah_item') ?>" method="post"
                                    enctype="multipart/form-data">
                                    <br>
										<input type="hidden" value="<?php echo $_GET['id_pengajuan'] ;?>" name="id_pengajuan" id="id_pengajuan">
									<div class="mb-3">
										<label for="program" class="form-label">Program</label>
										<select class="form-control" id="program" name="program" required>
											<option value="">Pilih Program</option>
											<?php foreach ($program as $item): ?>
												<option value="<?php echo $item['program_name']; ?>"><?php echo $item['program_name']; ?></option>
											<?php endforeach; ?>
										</select>
									</div>
                                    ...
                                    <div class="mb-3">
										...
										<select class="form-control" id="kegiatan" name="kegiatan" required>
											...
											<?php foreach ($kegiatan as $item): ?>
												<option value="<?php echo $item['kegiatan_name']; ?>"><?php echo $item['kegiatan_name']; ?></option>
											<?php endforeach; ?>
										</select>
									...
									<div class="mb-3">
										...
										<select class="form-control" id="kro" name="kro" required>
											...
											<?php foreach ($kro as $item): ?>
												<option value="<?php echo $item['kro_name']; ?>"><?php echo $item['kro_name']; ?></option>
											<?php endforeach; ?>
										</select>
									</div>
									...
									<div class="mb-3">
										...
										<select class="form-control" id="ro" name="ro" required>
											...
											<?php foreach ($ro as $item): ?>
												<option value="<?php echo $item['ro_name']; ?>"><?php echo $item['ro_name']; ?></option>
											<?php endforeach; ?>
										</select>
									</div>
									...
									<div class="mb-3">
										...
										<select class="form-control" id="komponen" name="komponen" required>
											...
											<?php foreach ($komponen as $item): ?>
												<option value="<?php echo $item['komponen_name']; ?>"><?php echo $item['komponen_name']; ?></option>
											<?php endforeach; ?>
										</select>
									</div>
                                    ...
                                    <div class="mb-3">
										...
										<select class="form-control" id="satuan" name="satuan" required>
											...
											<?php foreach ($satuan as $item): ?>
												<option value="<?php echo $item['satuan_name']; ?>"><?php echo $item['satuan_name']; ?></option>
											<?php endforeach; ?>
										</select>
                                    </div>
                                    ...
                                    <div class="d-grid gap-2">
                                        ...
                                        <a href="<?= base_url('Kabkota') ?>" class="btn btn-secondary">Kembali</a>
