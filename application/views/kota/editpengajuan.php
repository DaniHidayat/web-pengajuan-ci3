                        ...
                        <div class="card recent-sales overflow-auto">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-end mb-3">
                                    <a href="<?= base_url('Kabkota/tambahitem?id_pengajuan='.$id_pengajuan) ?>" type="button"
                                        class="btn btn-success mx-3" data-toggle="modal" data-target="#addModal"><i
                                            class="bi bi-plus"></i>Tambah
                                        item</a>
                                    <a href="<?= base_url('Kabkota') ?>" type="button" class="btn btn-secondary ml-2"><i
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php foreach ($import as $index => $row): ?>
                                        <tr>
                                            <td><?= $index + 1 ?></td>
                                            <td><?= $row->Program ?></td>
                                            <td><?= $row->Kegiatan ?></td>
                                ...
                                <div class="text-right mt-3">
                                    ...
                                    <a href="<?= base_url('Kabkota/downloadData/' . $id_pengajuan) ?>"
